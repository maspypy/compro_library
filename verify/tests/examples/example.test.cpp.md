...
# :heavy_check_mark: tests/examples/example.test.cpp

<a href="../../../index.html">Back to top page</a>

* <a href="{{ site.github.repository_url }}/blob/master/tests/examples/example.test.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "tests/examples/example.test.cpp"
#define PROBLEM "https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/4/ALDS1_4_B"
#include <algorithm>
#include <iostream>
#include <vector>
